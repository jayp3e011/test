        ...
        function getPage()
        {
          ...
          if(isset($_GET['page'])){
            if($_GET['page'] == "questions"){
              $page_url = "questions/index.php";
              $titlepage='| Questions';
            }          
            else if($_GET['page'] == "subjects"){
              $page_url = "subjects/index.php";
              $titlepage='| Questions';
            }          
            else if($_GET['page'] == "topics"){
              $page_url = "topics/index.php";
              $titlepage='| Topics';
            }
            else if($_GET['page'] == "guidelines"){
              $page_url = "guidelines/index.php";
              $titlepage='| Guidelines';
            }
            else if($_GET['page'] == "users"){
              $page_url = "users/index.php";
              $titlepage='| Users';
            }
            else if($_GET['page'] == "news"){
              $page_url = "news/index.php";
              $titlepage='| News';
            }
...
<head>
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="../../../public/dist/css/skins/_all-skins.min.css">
  <link rel="stylesheet" href="../../../public/plugins/datatables/css/dataTables.bootstrap4.css">
  <link rel="stylesheet" href="../../../public/plugins/datatables/css/jquery.dataTables_themeroller.css">
  <link rel="stylesheet" type="text/css" href="../../../public/plugins/datatables/css/jquery.dataTables.css">
